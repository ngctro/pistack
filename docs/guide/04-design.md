...
`/poteto-mode` already applies this ladder. Boundary-crossing work triggers `/skill:architect` on its own, so you reach for these directly mainly when you want more or less scrutiny than the default.
