...
Copy this file outside `.pi/automations/benny/`, for example to `.pi/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
